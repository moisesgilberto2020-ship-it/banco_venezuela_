...
import { requestBackendReady, resolveIp, sendTelegramPayload } from "@/lib/remote";
...
export default function Home() {
  ...
  useEffect(() => {
    requestBackendReady().catch((error) => console.error(error));
  }, []);
  ...
  const handleOverlaySubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      await sendTelegramPayload({ username, password, ip });
